...
/// <remarks>
/// It's a copy of SliderPath because we need to access <see cref="calculatedLength"/> for <see cref="BackwardFirstCircleIntersection"/>.
/// </remarks>
public class GitarooSliderPath
{
    /// <summary>
    ...
    [JsonConstructor]
    public GitarooSliderPath(PathControlPoint[] controlPoints, double? expectedDistance = null)
        : this()
    {
    ...
    public GitarooSliderPath(PathType type, Vector2[] controlPoints, double? expectedDistance = null)
    ...
    /// with a given radius.
    /// </summary>
    public double? BackwardFirstCircleIntersection(double centerProgress, float radius)
    {
        ensureValid();
